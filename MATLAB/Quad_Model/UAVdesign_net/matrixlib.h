...
extern void MatMultRR_Dbl(real_T         *y, 
                             const real_T   *A, 
                             const real_T   *B, 
                             const int_T dims[3]);

#ifdef CREAL_T
extern void MatMultRC_Dbl(creal_T       *y,
                             const real_T  *A,
                             const creal_T *B,
                             const int_T dims[3]);

extern void MatMultCR_Dbl(creal_T       *y,
                             const creal_T *A,
                             const real_T  *B,
                             const int_T dims[3]);

extern void MatMultCC_Dbl(creal_T       *y,
                             const creal_T *A,
                             const creal_T *B,
                             const int_T dims[3]);
#endif

extern void MatMultRR_Sgl(real32_T       *y,
                             const real32_T *A,
                             const real32_T *B,
                             const int_T  dims[3]);

#ifdef CREAL_T
extern void MatMultRC_Sgl(creal32_T       *y,
                             const real32_T  *A,
                             const creal32_T *B,
                             const int_T   dims[3]);

extern void MatMultCR_Sgl(creal32_T       *y,
                             const creal32_T *A,
                             const real32_T  *B,
                             const int_T   dims[3]);

extern void MatMultCC_Sgl(creal32_T       *y,
                             const creal32_T *A,
                             const creal32_T *B,
                             const int_T   dims[3]);
#endif

extern void MatMultAndIncRR_Dbl(real_T       *y,
                                   const real_T *A,
                                   const real_T *B,
                                   const int_T dims[3]);

#ifdef CREAL_T
extern void MatMultAndIncRC_Dbl(creal_T       *y,
                                   const real_T  *A,
                                   const creal_T *B,
                                   const int_T dims[3]);

extern void MatMultAndIncCR_Dbl(creal_T       *y,
                                   const creal_T *A,
                                   const real_T  *B,
                                   const int_T dims[3]);

extern void MatMultAndIncCC_Dbl(creal_T       *y,
                                   const creal_T *A,
                                   const creal_T *B,
                                   const int_T dims[3]);
#endif
extern void MatMultAndIncRR_Sgl(real32_T       *y,
                                   const real32_T *A,
                                   const real32_T *B,
                                   const int_T  dims[3]);

#ifdef CREAL_T
extern void MatMultAndIncRC_Sgl(creal32_T       *y,
                                   const real32_T  *A,
                                   const creal32_T *B,
                                   const int_T   dims[3]);

extern void MatMultAndIncCR_Sgl(creal32_T       *y,
                                   const creal32_T *A,
                                   const real32_T  *B,
                                   const int_T   dims[3]);

extern void MatMultAndIncCC_Sgl(creal32_T       *y,
                                   const creal32_T *A,
                                   const creal32_T *B,
                                   const int_T   dims[3]);
#endif 
...
extern void lu_real(real_T      *A,
                       const int_T n,
                       int32_T     *piv);

#ifdef CREAL_T
extern void lu_cplx(creal_T *A,
                       const int_T n,
                       int32_T *piv);
#endif

extern void lu_real_sgl(real32_T      *A,
                           const int_T n,
                           int32_T     *piv);

#ifdef CREAL_T
extern void lu_cplx_sgl(creal32_T *A,
                           const int_T n,
                           int32_T *piv);
#endif

extern void BackwardSubstitutionRR_Dbl(real_T          *pU,
                                          const real_T    *pb,
                                          real_T          *x,
                                          int_T            N,
                                          int_T            P,
...
#ifdef CREAL_T
extern void BackwardSubstitutionRC_Dbl(real_T          *pU,
                                          const creal_T   *pb,
                                          creal_T         *x,
                                          int_T            N,
                                          int_T            P,
...
extern void BackwardSubstitutionCC_Dbl(creal_T         *pU,
                                          const creal_T   *pb,
                                          creal_T         *x,
                                          int_T            N,
                                          int_T            P,
...
extern void ForwardSubstitutionRR_Dbl(real_T        *pL,
                                         const real_T  *pb,
                                         real_T        *x,
                                         int_T          N,
                                         int_T          P,
...
#ifdef CREAL_T
extern void ForwardSubstitutionRC_Dbl(real_T        *pL,
                                         const creal_T   *pb,
                                         creal_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void ForwardSubstitutionCR_Dbl(creal_T   *pL,
                                         const real_T    *pb,
                                         creal_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void ForwardSubstitutionCC_Dbl(creal_T   *pL,
                                         const creal_T   *pb,
                                         creal_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void BackwardSubstitutionRR_Sgl(real32_T          *pU,
                                          const real32_T    *pb,
                                          real32_T          *x,
                                          int_T              N,
                                          int_T              P,
...
#ifdef CREAL_T
extern void BackwardSubstitutionRC_Sgl(real32_T          *pU,
                                          const creal32_T   *pb,
                                          creal32_T         *x,
                                          int_T              N,
                                          int_T              P,
...
extern void BackwardSubstitutionCC_Sgl(creal32_T         *pU,
                                          const creal32_T   *pb,
                                          creal32_T         *x,
                                          int_T              N,
                                          int_T              P,
...
extern void ForwardSubstitutionRR_Sgl(real32_T    *pL,
                                         const real32_T    *pb,
                                         real32_T    *x,
                                         int_T     N,
                                         int_T     P,
...
#ifdef CREAL_T
extern void ForwardSubstitutionRC_Sgl(real32_T    *pL,
                                         const creal32_T   *pb,
                                         creal32_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void ForwardSubstitutionCR_Sgl(creal32_T   *pL,
                                         const real32_T    *pb,
                                         creal32_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void ForwardSubstitutionCC_Sgl(creal32_T   *pL,
                                         const creal32_T   *pb,
                                         creal32_T   *x,
                                         int_T     N,
                                         int_T     P,
...
extern void MatDivRR_Dbl(real_T        *Out,
                            const real_T  *In1,
                            const real_T  *In2,
                            real_T        *lu,
                            int32_T       *piv,
...
#ifdef CREAL_T
extern void MatDivRC_Dbl(creal_T       *Out,
                            const real_T  *In1,
                            const creal_T *In2,
                            real_T        *lu,
                            int32_T       *piv,
...
extern void MatDivCR_Dbl(creal_T       *Out,
                            const creal_T *In1,
                            const real_T  *In2,
                            creal_T       *lu,
                            int32_T       *piv,
...
extern void MatDivCC_Dbl(creal_T       *Out,
                            const creal_T *In1,
                            const creal_T *In2,
                            creal_T       *lu,
                            int32_T       *piv,
...
extern void MatDivRR_Sgl(real32_T        *Out,
                            const real32_T  *In1,
                            const real32_T  *In2,
                            real32_T        *lu,
                            int32_T         *piv,
...
#ifdef CREAL_T
extern void MatDivRC_Sgl(creal32_T       *Out,
                            const real32_T  *In1,
                            const creal32_T *In2,
                            real32_T        *lu,
                            int32_T         *piv,
...
extern void MatDivCR_Sgl(creal32_T       *Out,
                            const creal32_T *In1,
                            const real32_T  *In2,
                            creal32_T       *lu,
                            int32_T         *piv,
...
extern void MatDivCC_Sgl(creal32_T       *Out,
                            const creal32_T *In1,
                            const creal32_T *In2,
                            creal32_T       *lu,
                            int32_T         *piv,
